  ...
  <div class="container">
    ...
    <el-collapse>
      <el-collapse-item :name="1" title="环境配置">
        <div v-show="false" class="item-panel">
          ...
          <el-row class="item">5.创建基于NetBackup的备份时，如为Linux操作系统的机器，请确保该机器的RedHat操作系统版本在7以上，否则无法安装最新版本的备份软件,</el-row>
          <el-row class="item">6.如果机器已经安装旧版本NetBackup和NetWorker，请备份管理员手动卸载后再次提交</el-row>
        </div>
        <div class="item-panel">
          <el-row class="item">1. 对于操作系统类型为Linux的备份源机，请将/etc/sudoers文件中Defaultrequiretty注释</el-row>
          <el-row class="item">2. 对于操作系统类型为Windows的备份源机，请确保该服务器上的WinRM服务已打开，以便本平台远程登录该服务器。打开WinRM服务的操作命令如下，请在该机器的cmd终端以管理员方式执行: </el-row>
          <el-row class="item sub">1)初始化WinRm:winrm quickconfig</el-row>
          <el-row class="item sub">2)配置登陆方式:winrm set winrm/config/service/auth @{Basic="true"}</el-row>
          <el-row class="item sub">3)配置加密方式:winrm set winrm/config/service @{AllowUnencrypted="true"}</el-row>
          <el-row class="item">3. 创建基于NetBackup的备份时，自助备份系统将自动为源机安装9.1.0.1版本NetBackup备份软件，如为Linux操作系统的源机，请确保液机器的RedHat操作系统版本在7及以上;如为Windows操作系统的源机，请确保该机器的Windows操作系统版本在2012及以上，否则无法安装该版本的NetBackup，</el-row>
          <el-row class="item">4. 创建基于NetWorker的备份时，自助备份系统将自动为源机安装19.2.1.1版本的NetWorker备份软件，如为Linux操作系统的源机，请确保该机器的SUSE操作系统版本在12及以上;如为VMware，请确保该机器安装在VC 6及以上版本，否则无法使用该版本的NetWorker。</el-row>
          <el-row class="item">5. 如果机器已经安装低于9.1.0.1版本NetBackup和低于19.2.1.1版本NetWorker，请备份管理员手动卸载后再次提交</el-row>
        </div>
      </el-collapse-item>
      ...
      <el-collapse-item title="MYSQL创建备份须知">
        <div class="item-panel">
      ...
      <el-collapse-item title="PostgreSQL创建备份须知">
        <div class="item-panel">
          <el-row class="item">1.请提供需要进行备份的源机器的IP与主机名。</el-row>
      ...
      <el-collapse-item title="Oracle创建备份须知">
        <div class="item-panel">
      ...
      <el-collapse-item title="SQL Server创建备份须知">
        <div class="item-panel">
      ...
      <el-collapse-item title="HANA创建备份须知">
        <div class="item-panel">
      ...
      <el-collapse-item title="文件系统创建备份须知">
        <div class="item-panel">
